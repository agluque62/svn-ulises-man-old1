...
namespace NucleoGeneric
{
    ...
    class ftp : BaseCode
    {
        ...
        /* Download File */
        protected void download(string remoteFile, Stream localFileStream)
        {
            try
            {
        ...
        {
            download(remoteFile, new FileStream(localFile, FileMode.Create));
        }
        ...
        public void download(string remoteFile, ref string localstring)
        {
