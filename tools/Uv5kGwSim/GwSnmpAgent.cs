...
namespace Uv5kGwSim
{
    ...
    sealed class SnmpIntObject : MibObject      // ScalarObject
    {
        ...
        public int Value
        {
            ...
            set
            {
                if (Value != value)
                {
                    ...
                    {
                        GwSnmpAgent.Trap(Variable.Id, _data, _trapsEps);
                    }
                }
            }
        }
        ...
        /// <param name="oid"></param>
        /// <returns></returns>
        public static SnmpIntObject Get(GwSnmpAgent agent, string oid)
        {
            return agent.Store.GetObject(new ObjectIdentifier(oid)) as SnmpIntObject;
        }
    ...
    sealed class SnmpStringObject : MibObject   // ScalarObject
    {
        ...
        public void SendTrap(string value)
        {
            ...
            if ((_trapsEps != null) && (_trapsEps.Length > 0))
                GwSnmpAgent.Trap(Variable.Id, data, _trapsEps);
        }
        ...
        /// <param name="oid"></param>
        /// <returns></returns>
        public /*static*/ SnmpStringObject Get(GwSnmpAgent agent, string oid)
        {
            return agent.Store.GetObject(new ObjectIdentifier(oid)) as SnmpStringObject;
        }
