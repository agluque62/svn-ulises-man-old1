...
namespace Uv5kTopSim
{
    ...
    sealed class SnmpIntObject : MibObject      // ScalarObject
    {
        ...
        public int Value
        {
            ...
            set
            {
                if (Value != value)
                {
                    ...
                    {
                        TopSnmpAgent.Trap(Variable.Id, _data, _trapsEps);
                    }
                }
            }
        }
        ...
        {
            return TopSnmpAgent.Store.GetObject(new ObjectIdentifier(oid)) as SnmpIntObject;
        }
    ...
    sealed class SnmpStringObject : MibObject   // ScalarObject
    {
        ...
        public void SendTrap(string value)
        {
            ...
            if ((_trapsEps != null) && (_trapsEps.Length > 0))
                TopSnmpAgent.Trap(Variable.Id, data, _trapsEps);
        }
        ...
        {
            return TopSnmpAgent.Store.GetObject(new ObjectIdentifier(oid)) as SnmpStringObject;
        }
	...
	static class TopSnmpAgent
	{
		...
		{
			get { return TopSnmpAgent._store; }
		}
